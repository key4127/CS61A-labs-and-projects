...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided, # may need to improve
    ...
    while score0 < goal and score1 < goal:
        if (who == 0):
            ...
            if feral_hogs == True and abs(roll_num - point0) == 2:
                score0 += 3
            point0 = take_turn(roll_num, score1, dice)
            score0 += point0
            score = score0
            opponent_score = score1
        else :
            roll_num = strategy1(score1, score0)
            if feral_hogs == True and abs(roll_num - point1) == 2:
                score1 += 3
            point1 = take_turn(roll_num, score0, dice)
            score1 += point1
            score = score1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    if who == 0:
        ...
        def announce(score0, score1, last_score = 0, running_high = 0):
            ...
            last_score = score1
            def new_announce(score0, score1):
                return announce(score0, score1, last_score = last_score, running_high = running_high)
            return new_announce
        return announce
    # END PROBLEM 7
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    swap = is_swap(score + point, opponent_score)
    if swap == True and opponent_score > score + point:
        return 0
    if (swap == True and opponent_score == score + point) or swap == False:
        if point >= cutoff:
            return 0
    return num_rolls  # Replace this statement
    # END PROBLEM 11
...
def final_strategy(score, opponent_score): # need to implement
