...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lat_dif = get_lat(city_a) - get_lat(city_b)
    lon_dif = get_lon(city_a) - get_lon(city_b)
    return sqrt(lat_dif ** 2 + lon_dif ** 2)
...
def add_chars(w1, w2):
    ...
    if w1[0] == w2[0]:
        ...
        return w2[0] + add_chars(w1, w2[1:]) # w2[0] is string, it equals w2[:1] 
